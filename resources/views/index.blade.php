...
@section('container')
	...
	<div id="indexPage">
		@if(Auth::check())
			<a href="{{ url('room') }}" style="display:inline-block;padding:10px;margin:40px;background:#3F51B5;text-decoration:none;color:#fff"><i class="xi-stack-paper"></i> Room List</a>
		@endif
		<div class="welcome">
